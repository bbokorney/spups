 ...
 */
public class PlaceVillageTileUIState extends GameplayUIState {
    ...
    public PlaceVillageTileUIState(Controller controller, KeyListener keyListener, GameModel model){
        this.controller = controller;
        this.keyListener = keyListener;
        this.model = model;

	    potentialAction = new PotentialPlaceVillageTile(model, controller.getPalaceFestival());
	...
	public void confirmPlacement() {
		Pair<ActionResult, PlaceVillageTile> actionPair = potentialAction.confirmPlacement();
